...
def main():
    ...
    run('advanced alignment location diff json', [PY, 'scripts/advanced_alignment.py', '--date', '2026-06-29', '--birth-date', '2003-04-19', '--birth-place', '哈尔滨', '--residence-place', '杭州', '--current-place', '广州', '--city', '广州', '--constitution-demo', '--mock', '--json'], json_has(['location_difference', 'unique_regions']))
